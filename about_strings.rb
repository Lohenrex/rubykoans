...
class AboutStrings < Neo::Koan
  ...
  def test_use_single_quotes_to_create_string_with_double_quotes
    ...
    assert_equal string = 'He said, "Go Away."', string
  end
...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # A: Because it does not create another object like (+=) does, it just
    # alters the original object referenced by the (=) operator
  end
